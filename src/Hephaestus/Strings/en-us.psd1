# The text the Windows PE window shows, in the language of the file name.
#
# EDIT THIS RATHER THAN THE MARKUP. Every key is <control>.<property>,
# so a string is written where the control that shows it is named, and a
# sentence exists once. To translate the window, copy this file to the
# culture you want - he-il.psd1, de-de.psd1 - and translate the values;
# anything left out falls back to this file rather than to a blank label.
