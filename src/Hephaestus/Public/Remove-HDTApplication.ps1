function Remove-HDTApplication {
    <#
        ...
        .EXAMPLE
            Remove-HDTApplication -Workspace 'C:\HDTLab\Share' -Id '7Zip-24.09'

        .EXAMPLE
            (Remove-HDTApplication -Workspace 'C:\HDTLab\Share' -Id '7Zip-24.09' -WhatIf).RequiredBy
    ...
    $folder = Get-HDTWorkspacePath -Root $Workspace -Kind Applications -ChildPath $Id
    ...
    # removed.
    $applicationRoot = Get-HDTWorkspacePath -Root $Workspace -Kind Applications
