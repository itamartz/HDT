...
Describe 'E2E workflow' {
    ...
    It 'is given a deadline rather than left burning' -Skip:$script:HDTYamlMissing {
        ...
        $script:job['timeout-minutes'] | Should -BeGreaterThan 0
        $script:job['timeout-minutes'] | Should -BeLessOrEqual 720
    }
    ...
    It 'triggers on demand and on a schedule, and on nothing else' {
