function Get-HDTStepParent {
    <#
        ...
        .DESCRIPTION
            ...
            Move-HDTStep refuses to do, because a step that changes group
            ...
            blocks, so Get-HDTStepBlock stays a description of the
            document's text and nothing else.

        .PARAMETER Block
            The blocks from Get-HDTStepBlock, in document order.
